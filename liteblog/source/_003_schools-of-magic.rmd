...
```{r}
with_short_names <- function(mat) {
  rownames(mat) <- str_trunc(rownames(mat), width = 6, ellipsis = ".")
  colnames(mat) <- str_trunc(colnames(mat), width = 6, ellipsis = ".")
  mat
}
...
```{r}
print(with_short_names(class_distro), digits = 2)
```
...
```{r}
print(with_short_names(school_distro), digits = 2)
```
...
print(with_short_names(class_dissim), digits = 2)
```
